window.addEventListener("load", function(){
	...
	/*hacer aparecer otra caja encima de la anterior al hacer click y a esa nueva caja darle un rows 3*/
	cajaTexto.addEventListener("click", function(){
		cajaTexto.rows = 3;
	});

    /*crear una funcion para hacer que al dar click en una nueva caja se cree otra caja*/
